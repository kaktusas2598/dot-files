...
local mappings = {
    ...
    ["fr"] = { "<cmd>lua require('telescope.builtin').registers()<cr>", "Find Registers" },
    ...
    g = {
        ...
        b = { "<cmd>ToggleBlame virtual<cr>", "Blame all lines" }
    },
    ...
    l = {
        ...
        -- For C++ formatting is definitely broken, haven't tried with other langs
