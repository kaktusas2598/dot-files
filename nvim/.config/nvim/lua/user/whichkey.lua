...
which_key.add({
    ...
    { "<leader>bl", "<cmd>lua require('telescope.builtin').buffers(require('telescope.themes').get_dropdown{previewer = false})<cr>", desc = "List", nowait = true, remap = false },
    { "<leader>bn", "<cmd>bnext<cr>", desc = "Next", nowait = true, remap = false },
    { "<leader>bp", "<cmd>bprev<cr>", desc = "Previous", nowait = true, remap = false },
    { "<leader>d", group = "Debug", nowait = true, remap = false },
    { "<leader>db", "<cmd>DapToggleBreakpoint<cr>", desc = "Breakpoint", nowait = true, remap = false },
    ...
    { "<leader>ds", "<cmd>DapStepOver<cr>", desc = "Step", nowait = true, remap = false },
    ...
    { "<leader>fr", "<cmd>lua require('telescope.builtin').registers()<cr>", desc = "Find Registers", nowait = true, remap = false },
    { "<leader>ft", "<cmd>TodoTelescope<cr>", desc = "Find TODOs", nowait = true, remap = false },
    { "<leader>g", group = "Git", nowait = true, remap = false },
    { "<leader>gB", "<cmd>Telescope git_branches<cr>", desc = "Checkout branch", nowait = true, remap = false },
    { "<leader>gR", "<cmd>lua require 'gitsigns'.reset_buffer()<cr>", desc = "Reset Buffer", nowait = true, remap = false },
    { "<leader>gb", "<cmd>ToggleBlame virtual<cr>", desc = "Blame all lines", nowait = true, remap = false },
